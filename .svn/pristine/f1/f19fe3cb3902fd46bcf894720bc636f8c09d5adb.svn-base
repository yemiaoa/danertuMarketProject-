...
-(void)initView{
    ...
    [self.view setBackgroundColor:[UIColor colorWithRed:255.0 / 255.0 green:238.0 / 255.0 blue:238.0 / 255.0 alpha:1.0]];
    ...
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, addStatusBarHeight, MAINSCREEN_WIDTH, MAINSCREEN_HEIGHT - addStatusBarHeight)];
    _tableView.separatorStyle = UITableViewCellSeparatorStyleNone;
    _tableView.backgroundView = nil;
    _tableView.backgroundColor = [UIColor colorWithRed:255.0 / 255.0 green:238.0 / 255.0 blue:238.0 / 255.0 alpha:1.0];
    ...
    headerView.frame = CGRectMake(0, 0, MAINSCREEN_WIDTH, 100);
    ...
    //黄色背景
    topSegmentView = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 50, MAINSCREEN_WIDTH, 50)];
...
//    UIImageView *btImage = [[UIImageView alloc] init];
//    btImage.backgroundColor = [UIColor colorWithRed:229.0 / 255.0 green:101.0 / 255.0 blue:15.0 / 255.0 alpha:1.0];
    
    UIImage *btImage = [self buttonImageFromColor:[UIColor colorWithRed:229.0 / 255.0 green:101.0 / 255.0 blue:15.0 / 255.0 alpha:1.0] size:CGSizeMake(100, 50)];
    
    UIButton *callButton = [[UIButton alloc] init];
    callButton.frame = CGRectMake(SCREENWIDTH - 100, 0, 100, 50);
    [callButton setBackgroundImage:btImage forState:UIControlStateNormal];
    [callButton addTarget:self action:@selector(callOnTelephone) forControlEvents:UIControlEventTouchUpInside];
    [callButton setTitle:@"联系咨询" forState:UIControlStateNormal];
    [callButton.titleLabel setFont:[UIFont systemFontOfSize:17.0]];
    [topSegmentView addSubview:callButton];
...
//    [topSegmentView addGestureRecognizer:tap];
    ...
    float itemY = addStatusBarHeight +220;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell) {
        cell = [[SellShopCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIndentifier withCellSize:cellSize];
    ...
    cell.realNameLabel.text = [NSString stringWithFormat:@"%@",[tempDic valueForKey:@"RealName"]];
    cell.mobileLabel.text = [NSString stringWithFormat:@"%@",[tempDic valueForKey:@"Mobile"]];
    
    cell.shopDict = tempDic;
...
{
    UIView *headerBgView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREENWIDTH, 50)];
    headerBgView.backgroundColor = [UIColor colorWithRed:255.0 / 255.0 green:238.0 / 255.0 blue:238.0 / 255.0 alpha:1.0];
    
    UIView *subView = [[UIView alloc] initWithFrame:CGRectMake(0, 10, 5, 30)];
    subView.backgroundColor = [UIColor colorWithRed:241.0 / 255.0 green:126.0 / 255.0 blue:48.0 / 255.0 alpha:1.0];
    [headerBgView addSubview:subView];
    
    UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, 10, 100, 30)];
    titleLabel.backgroundColor = [UIColor clearColor];
    titleLabel.textColor = [UIColor colorWithWhite:153.0 / 255.0 alpha:1.0];
    [headerBgView addSubview:titleLabel];
    titleLabel.text = @"下级店铺";
