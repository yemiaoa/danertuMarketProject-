...
#define WXAPP_ID          @"wx58f1866c456080f3"               //APPID
#define WXAPP_SECRET      @"a07ac35ad3e0229902c1bfe825086950" //appsecret
//商户号，填写商户对应参数
#define WXMCH_ID          @"1274110001"
//商户API密钥，填写相应参数
#define WXPARTNER_ID      @"YTA3YWMzNWFkM2UwMjI5OTAyYzFiZmU4"
//支付结果回调页面
...
//签名实例测试
- (NSMutableDictionary *)sendPayWithDict:(NSMutableDictionary *)dict;
