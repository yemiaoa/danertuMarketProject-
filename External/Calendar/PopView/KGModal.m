...
@interface KGModalViewController : HeBaseViewController
...
- (id)initWithFrame:(CGRect)frame{
    ...
    styleLayer.borderWidth = 0.7;
    styleLayer.borderColor = [[UIColor orangeColor] CGColor];//外边框
    styleLayer.backgroundColor = [UIColor orangeColor].CGColor;//边框里边的黑色线条
    styleLayer.frame = CGRectInset(self.bounds, 15, 15);//  padding = 17
