...
- (void)photoViewSingleTap:(MJPhotoView *)photoView
{
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 7.0) {
        [[NSNotificationCenter defaultCenter] postNotificationName:@"UPDATE_MJPhotoView_Frame_FOR_IOS7" object:nil];
    }
...
- (void)loadImageNearIndex:(int)index
{
    if (index > 0) {
        ...
        [[SDWebImageManager sharedManager] downloadImageWithURL:[NSURL URLWithString:photo.url] options:SDWebImageCacheMemoryOnly progress:^(NSInteger receivedSize, NSInteger expectedSize) {
